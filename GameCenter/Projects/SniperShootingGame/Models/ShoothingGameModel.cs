...
namespace GameCenter.Projects.SniperShootingGame.Models
{
    class ShoothingGameModel
    {
        ...
        public ShoothingGameModel()
        {
            ...
            backgroundImage.ImageSource = new BitmapImage(new Uri("Projects/SniperShootingGame/Assets/background.png", UriKind.Relative));
            ghostSprite.ImageSource = new BitmapImage(new Uri("Projects/SniperShootingGame/Assets/ghost.png", UriKind.Relative));
        }
        ...
        public void CreateDummy(int x, int y,int skin, string tag, Canvas gameCanvas)
        {
            ...
            {
                case 1:
                    dummyBackground.ImageSource = new BitmapImage(new Uri("Projects/SniperShootingGame/Assets/dummy01.png", UriKind.Relative));
                    break;

                case 2:
                    dummyBackground.ImageSource = new BitmapImage(new Uri("Projects/SniperShootingGame/Assets/dummy02.png", UriKind.Relative));
                    break;

                case 3:
                    dummyBackground.ImageSource = new BitmapImage(new Uri("Projects/SniperShootingGame/Assets/dummy03.png", UriKind.Relative));
                    break;

                case 4:
                    dummyBackground.ImageSource = new BitmapImage(new Uri("Projects/SniperShootingGame/Assets/dummy04.png", UriKind.Relative));
                    break;
            }
